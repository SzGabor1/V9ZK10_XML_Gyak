...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html>
			<body>
				<h2>Martinák Mátyás Órarend – 2023/24. I. félév.</h2>
				...
				<table border="4">
					...
					<xsl:for-each select="V9ZK10_orarend/ora">
						<tr>
							<td>
							...
							<td><xsl:value-of select="idopont/tol" />h - <xsl:value-of
									select="idopont/ig" />h</td>
							<td>
