...
public class xPathModify {
    ...
    public static void main(String[] args) {
        try {
            ...
            File inputFile = new File("E:\\egyetem\\XML\\V9ZK10_XML_Gyak\\2023.11.22\\V9ZK10_kurzusfelvetel.xml");
            ...
            saveToFile(doc, "V9ZK10_kurzusfelvetel1.xml");
    ...
    private static void addNewCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Element kurzusokElement = (Element) xPath.compile("2023.11.22\\V9ZK10_kurzusfelvetel1.xml").evaluate(doc,
                XPathConstants.NODE);
    ...
    private static void deleteCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToDelete = (Node) xPath.compile("/V9ZK10_kurzusfelvetel/kurzusok/kurzus[@id='GEIAL120-B']")
    ...
    private static void modifyCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToModify = (Node) xPath.compile("/V9ZK10_kurzusfelvetel/kurzusok/kurzus[@id='GEMAK234-B']")
                .evaluate(doc, XPathConstants.NODE);
